...
class DataValidation:
    ...
    def is_required_columns_exists(self, base_df:pd.DataFrame, current_df:pd.DataFrame, report_key_name:str)->bool:
        try:
            base_columns= base_df.columns # base data
            current_columns = current_df.columns

            missing_columns = []
            for base_column in base_columns:
                if base_column not in current_columns:
                    logging.ingo(f"column:[{base_column} is not available.]")
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationfact:
        try:
            ...
            data_validation_artifact = artifact_entity.DataValidationfact(report_file_path=self.data_validation_config.report_file_path)
